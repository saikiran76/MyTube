    ...
    return(
        <div className="grid grid-flow-col shadow-lg">
            <div className="flex flex-row">
                <img onClick={()=>toogleHandler()} className="h-16 bg-transparent cursor-pointer" src="https://www.svgrepo.com/show/312300/hamburger-menu.svg" alt="Ham"/>
                <img className="h-16 cursor-pointer" src="https://t3.ftcdn.net/jpg/04/03/98/64/360_F_403986499_hB7zfgOXezReA0sKkxl34RoT9TbNkbpH.jpg" alt="mytube"/>
            </div>
               
            <div className="col-span-10 px-10">
                <input className="h-1/2 rounded-l-full w-1/2 m-3 mr-0 p-4" placeholder="What's in your mind?"></input>
                <button className="h-1/2 w-16 rounded-r-full bg-gray-200 p-2">
                   Search
                </button>
            </div>
